...
{
	[ObjectSystem]
	public class FGUIComonentAwakeSystem : AwakeSystem<FGUIComponent>
	{
	...
	[ObjectSystem]
	public class FGUIComonentLoadSystem : LoadSystem<FGUIComponent>
	{
		public override void Load(FGUIComponent self)
		{
			self.Load();
		}
	}
