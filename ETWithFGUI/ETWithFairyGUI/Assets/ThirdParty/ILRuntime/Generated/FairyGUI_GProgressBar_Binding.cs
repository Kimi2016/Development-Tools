...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GProgressBar_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_titleType_0);
            args = new Type[]{typeof(FairyGUI.ProgressTitleType)};
            method = type.GetMethod("set_titleType", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_titleType_1);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, set_max_3);
            args = new Type[]{};
            ...
            args = new Type[]{};
            method = type.GetMethod("get_reverse", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_reverse_6);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_reverse", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_reverse_7);
            args = new Type[]{typeof(System.Double), typeof(System.Single)};
            method = type.GetMethod("TweenValue", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TweenValue_8);
            args = new Type[]{typeof(System.Double)};
            ...
            app.RegisterCLRMethodRedirection(method, ConstructFromXML_10);
            args = new Type[]{typeof(FairyGUI.Utils.XML)};
            method = type.GetMethod("Setup_AfterAdd", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Setup_AfterAdd_11);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new FairyGUI.GProgressBar());
            app.RegisterCLRCreateArrayInstance(type, s => new FairyGUI.GProgressBar[s]);
        ...
        static StackObject* get_titleType_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_titleType_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* set_max_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_reverse_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_reverse_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.reverse = value;

            return __ret;
        }

        static StackObject* TweenValue_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* Update_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Double @newValue = *(double*)&ptr_of_this_method->Value;

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            FairyGUI.GProgressBar instance_of_this_method = (FairyGUI.GProgressBar)typeof(FairyGUI.GProgressBar).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Update(@newValue);

            return __ret;
        }

        static StackObject* ConstructFromXML_10(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* Setup_AfterAdd_11(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new FairyGUI.GProgressBar();
