...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GSlider_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ConstructFromXML_8);
            args = new Type[]{typeof(FairyGUI.Utils.XML)};
        ...
        static StackObject* ConstructFromXML_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
